    ...
    <div class="card-body pt-2 pb-3">
        ...
        @else
            <div class="text-center py-3">
                ...
                <p class="text-muted mt-2 mb-0" style="font-size: 0.75rem;">Vous n'avez aucune cotisation privée. Utilisez « Rechercher par code » pour demander l'adhésion à une cotisation privée.</p>
            </div>
        @endif
    </div>
</div>
